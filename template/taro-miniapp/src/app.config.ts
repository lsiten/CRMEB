export default defineAppConfig({
  pages: ['pages/index/index', 'pages/goods/index', 'pages/detail/index', 'pages/search/index', 'pages/cart/index', 'pages/user/index', 'pages/order/confirm', 'pages/order/pay', 'pages/order/list', 'pages/order/detail', 'pages/order/logistics'],
