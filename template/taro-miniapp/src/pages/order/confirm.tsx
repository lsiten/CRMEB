...
export default function ConfirmOrderPage() {
  ...
  const items = useMemo(() => readCart(), []); const [address, setAddress] = useState(''); const [mode, setMode] = useState<Fulfillment['type']>('delivery'); const [store, setStore] = useState<Store>(); const [submitting, setSubmitting] = useState(false);
